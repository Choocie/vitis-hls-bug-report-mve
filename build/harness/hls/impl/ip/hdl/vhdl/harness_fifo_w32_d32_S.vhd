...
entity harness_fifo_w32_d32_S is 
    generic (
...
architecture rtl of harness_fifo_w32_d32_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component harness_fifo_w32_d32_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 5;
        DEPTH      : integer := 32);
...
begin
----------------------- Instantiation -----------------------
    U_harness_fifo_w32_d32_S_ShiftReg : harness_fifo_w32_d32_S_ShiftReg
    generic map (
...
entity harness_fifo_w32_d32_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 5;
        DEPTH      : integer := 32);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end harness_fifo_w32_d32_S_ShiftReg;

architecture rtl of harness_fifo_w32_d32_S_ShiftReg is
