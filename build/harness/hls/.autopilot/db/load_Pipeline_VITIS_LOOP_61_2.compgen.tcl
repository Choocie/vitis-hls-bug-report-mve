...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler harness_lshr_2192ns_10ns_2192_2_1 BINDTYPE {op} TYPE {lshr} IMPL {auto_pipe} LATENCY 1
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename nums_1 \
    op interface \
    ports { nums_1_address0 { O 13 vector } nums_1_ce0 { O 1 bit } nums_1_q0 { I 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_p_cast5_i_cast \
    op interface \
    ports { p_cast5_i_cast { I 2 vector } } \
} "
}
